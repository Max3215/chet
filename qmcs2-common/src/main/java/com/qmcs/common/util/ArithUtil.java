...
public class ArithUtil {   
    ...
    */   
     ...
     * @return 两个参数的差
     */
    public static double subZ(double v1,double v2){
        BigDecimal b1 = new BigDecimal(Double.toString(v1));
        BigDecimal b2 = new BigDecimal(Double.toString(v2));
        return b1.subtract(b2).doubleValue() > 0 ? b1.subtract(b2).doubleValue() : 0;
    }
     ...
     * @return 两个参数的差
     */
    public static BigDecimal subBig(double v1,double v2){
        BigDecimal b1 = new BigDecimal(Double.toString(v1));
        BigDecimal b2 = new BigDecimal(Double.toString(v2));
    ...
    public static double divDown(double v1,double v2,int scale){   
        ...
        BigDecimal b1 = new BigDecimal(Double.toString(v1));   
        BigDecimal b2 = new BigDecimal(Double.toString(v2));   
        return b1.divide(b2,scale,BigDecimal.ROUND_DOWN).doubleValue() >0 ? b1.divide(b2,scale,BigDecimal.ROUND_DOWN).doubleValue() : 0;
    }

    public static void main(String[] args){
        System.out.println(divDown(25,25));
    }
     ...
     * @return
     */
    public static double roundRoundDown(double v1,double v2,int scale){
        return roundRoundDown(div(v1,v2),2);
    }
