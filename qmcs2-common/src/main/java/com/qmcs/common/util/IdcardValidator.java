...
public class IdcardValidator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String idcard18 = "500231199002013572";//
        // 15位身份证
        System.out.println(isValidatedAllIdcard(idcard15));
        // 18位身份证
        System.out.println(formatBirthDay(getBirthByIdCard(idcard15)));
        // 15位身份证转18位身份证
    ...
    public static String formatBirthDay(String idCard){
        String birthday = getBirthByIdCard(idCard);
        if (birthday.length() == 6)
            return "19"+birthday.substring(0,2)+"-"+birthday.substring(2,4)+"-"+birthday.substring(4,6);
